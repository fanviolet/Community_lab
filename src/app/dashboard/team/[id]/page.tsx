    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">
            {member.data.display_name || member.data.email}
          </h1>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    Joined{" "}
                    {new Date(member.data.created_at).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
      ...
      <Tabs defaultValue="skills" className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="availability">Khả dụng</TabsTrigger>
        ...
        <TabsContent value="activity" className="space-y-6">
          <Card className="border-0 bg-white shadow-sm ring-1 ring-black/5">
            <CardHeader>
              ...
              <CardDescription>
                Hoạt động gần đây của thành viên này
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                {activity.filter((a: any) => a.profile_id === memberId)
                  .length === 0 && (
